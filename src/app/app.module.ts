...
import { PollReportsComponent } from './auth/poll-reports/poll-reports.component';
...
@NgModule( {
  ...
  providers: [ PollsService, HttpService, PublicGuard, AuthGuard, AuthenticationService, VotesService ],
